      ...
      <div className="bg-white rounded-lg shadow p-6 space-y-4">
          ...
          <div className="bg-gray-100 p-4 rounded">
            ...
            {userRole !== "superadmin" && (
              <div className="space-y-2">
                <p className="text-sm text-gray-600 mb-2">Update your role (requires superadmin or database access):</p>
                <div className="flex gap-2">
                  <button
                    onClick={() => updateRole("admin")}
                    disabled={updating || userRole === "admin" || userRole === null}
                  ...
                  <button
                    ...
                    disabled={updating || (userRole !== null && userRole !== "user" && userRole !== "admin")}
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded p-4">
          ...
          <ul className="list-disc list-inside text-yellow-700 space-y-1">
            ...
            <li>Otherwise, update it directly in MongoDB or ask a superadmin to update it</li>
          </ul>
        </div>
      </div>
    </div>
